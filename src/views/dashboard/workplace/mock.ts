...
const dataCount = [
  [
    {
      avatar: "//p3-armor.byteimg.com/tos-cn-i-49unhts6dw/288b89194e657603ff40db39e8072640.svg~tplv-49unhts6dw-image.image",
      title: "用户总数",
      value: 4626,
    },
    {
...
setupMock({
  setup() {
    Mock.mock(new RegExp('/api/data-count'), () => {
      return successResponseWrap([...dataCount]);
    })
